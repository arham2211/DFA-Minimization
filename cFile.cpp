...
void print_dfa_table(int tab[][SYMBOLS], int nstates, int nsymbols, const char* finals){
    int i, j;

    cout << "\nDFA: STATE TRANSITION TABLE\n";
    cout << "     | ";
    for (i = 0; i < nsymbols; i++) cout << "  " << i << "  ";

    cout << "\n-----+--";
    for (i = 0; i < nsymbols; i++) cout << "-----";
    cout << "\n";
